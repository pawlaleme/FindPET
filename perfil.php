      ...
      ?>
        ...
        <div class="botoesdashperfil">
         ...
         <div class="container2">
          ...
          <h1 class="tituloperfil">Meus Pets Perdidos</h1>
          <div class="containerpets">
      <?php    
          $resultadoperdidos = buscarPerdidoUsuarioAtivoDAO($_SESSION['idusuario']);
      ...
      ?>
          ...
          <div class="imagepets">
                ...
                <div class="containerDescricao">
                  <p>
                    <?php echo $registroperdidos->descricao; ?>
                  </p>
                </div>
              <div class="btns">
                <div>
                <a href="editarperdido.php?idpetperdido=<?php echo $registroperdidos->idpetperdido; ?>"><button><i class='bx bx-pen' ></i>Editar</button></a>
                
                </div>
                <form action="../Forms/processaTodosFormularios.php?idpetperdido=<?php echo $registroperdidos->idpetperdido; ?>" method="POST">
                    <button name="acao" value="excluirperdido"><i class='bx bx-trash' ></i>Excluir</button>
                  </form>
                <div>                
