    ...
    <?php                    
      ...
      ?>
        ...
        <div class="botoesdashperfil">
         ...
         <div class="container2">
          ...
          <h1 class="tituloperfil">Meus Pets para Adoção</h1>
          <div class="containerpets">
      <?php    
          $resultadoadotados = buscarAdocaoUsuarioAtivoBO($_SESSION['idusuario']);
      ...
      ?>
          <div class="boxpets">
              ...
              <p><?php echo $registroadotados->descricao; ?></p>
              </div>
              <div class="btns">
              <div>
              <a href="editaradocao.php?idpetadocao=<?php echo $registroadotados->idpetadocao; ?>"><button><i class='bx bx-pen' ></i>Editar</button></a>
                </div>
                <div>
                  <form action="../Forms/processaTodosFormularios.php?idpetadocao=<?php echo $registroadotados->idpetadocao; ?>" method="POST">
                    <button name="acao" value="excluiradocao"><i class='bx bx-trash' ></i>Excluir</button>
                  </form>
                </div>
                <div>                
