 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <body class="bdashboard">
    ...
    <header>
      ...
      <div class="wrapper">
        <h2>Encontrou um pet que não é seu? Nós ajudamos a encontrar o dono!</h2>
        <div class="input-box">
        ...
        <p class='field'>
          ...
          <input type='text' name='desc' title='Description' placeholder="Fale sobre o pet" />
          <span id='valida' class='i i-warning'></span>
        </p>
        
        <p class='field'>
          <label for='user'>Cidade</label>
          <input type='text' name='cidade' title='City' placeholder="Cidade onde ele foi encontrado" />
          <span id='valida' class='i i-warning'></span>
        </p>
    ...
    <div class="bottom">
      ...
      <div class="">
        <button type="submit" name="acao" value="cadastrarpetencontrado">Publicar</button>
      </div>
    </div>
  ...
  <div class="sidebar">
    ...
    <h1 class="tituloperfil">PETS ENCONTRADOS</h1>

    <div class="containerpets">
      <?php  
  
          $resultadoencontrados = buscarEncontradoGeralBO();
      ...
      ?>
          ...
          <div class="boxpets">
              ...
              <div class="btns">
                <?php
                if($_SESSION['idusuario'] == $registroencontrados->idusuario){
                ?>
                <a href="Usuarioencontrados.php"><button>Acessar seu perfil</button></a>
                <?php 
                }else
                {
                ?>
                    <a href="OutroUsuarioencontrados.php?idoutrousuario=<?php echo $registroencontrados->idusuario; ?>"><button>Entrar em contato</button></a>
