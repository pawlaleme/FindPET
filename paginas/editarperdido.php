...
<link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <body class="bdashboard">
    ...
    <header>
    <?php                    
            $resultado = editarperdidoPorIDDAO($_GET['idpetperdido']);                          
      ...
      ?>
        ...
        <div class="wrapper">
              <h2>Editar Pet Perdido:</h2>
              <div class="input-box">
                <form action="../Forms/processaTodosFormularios.php" enctype="multipart/form-data" method="POST">
                
                <input type="hidden" name="idpetperdido" value="<?php echo $_GET['idpetperdido']; ?>">
                <input type="hidden" name="token" value="<?php echo $registro->foto; ?>">
            
                <label for='status'>Status</label>                
                <?php $statuscorreto = $registro->dataencontro;?> 
                <select id="status" name="status">
                    <option value="disp" <?php if($statuscorreto == null){ echo "selected"; } ?>>Perdido</option>
                    <option value="adopt" <?php if($statuscorreto != null){ echo "selected"; } ?>>Encontrado</option>
                </select>
          ...
          <div class="bottom">
            ...
            <div class="">
              <button type="submit" name="acao" value="editarpetperdido">Publicar</button>
            </div>
          </div>
